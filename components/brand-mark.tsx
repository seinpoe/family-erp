...
export function BrandMark({ className }: { className?: string }) {
  return (
    <div className={cn("flex items-center gap-2", className)}>
      <span className="grid size-9 place-items-center border border-brand bg-brand text-white shadow-tactile-sm" aria-hidden="true"><Layers3 className="size-4" strokeWidth={2.5} /></span>
