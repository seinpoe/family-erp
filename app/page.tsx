...
function FeatureBlock({ icon: Icon, title, copy }: { icon: typeof LockKeyhole; title: string; copy: string }) { return <div className="border border-canvas/45 p-4"><Icon className="size-5" strokeWidth={2.2} aria-hidden="true" /><h2 className="mt-5 text-lg font-black uppercase tracking-[-0.05em]">{title}</h2><p className="mt-2 text-sm leading-6 text-canvas/70">{copy}</p></div>; }
